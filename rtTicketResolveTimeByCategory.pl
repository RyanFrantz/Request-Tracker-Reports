...
#
# rtTicketResolveTimeByCategory.pl - query RT and generate a report on how long it took to resolve requests, by category
#
...
my $query = qq[ Created > '2011-09-18' AND ( Queue = 'Support Desk (Level 1)' OR Queue = 'Support Desk (Level 2)' ) AND Status = 'resolved' ];
