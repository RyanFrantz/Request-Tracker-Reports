...
#
# rtTicketLifetimeByOwner.pl - query RT and generate a report on the lifetime of resolved tickets, by owner
#
...
}	# end queryTicketLifetime()

foreach my $owner ( @supportDeskTechs ) {
	print "OWNER: " . $owner . "\n";
	queryTicketLifetime( $owner);
}
